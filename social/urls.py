...
from .views import PostListView,PostDetailView,PostEditView,PostDeleteView,CommentDeleteView,ProfileEditView,ProfileView,AddFollower,RemoveFollower,AddLike,AddDislike, ThreadNotification,UserSearch ,ListFollowers ,AddCommentLike,AddCommentDislike,CommentReplyView,PostNotification,FollowNotification,RemoveNotification,CreateThread,ListThreads,ThreadView,CreateMessage,SharedPostView
urlpatterns = [ 
